...
const CACHE = 'sovenn-0.54.0';
const SHELL = ['./','index.html','card.html','app.js','qr.js','capture.js','shuffle.js','memory.js','streak.js','notify.js','styles.css','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png','icon-maskable-512.png','apple-touch-icon.png','favicon-32.png','favicon-16.png'];
